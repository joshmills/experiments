...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=mountain_test_1&box=-115.387034,36.238552,-115.587510,36.076855
...
-----------
  ...
  * mountain_test_1 Height Map (ASTER 30m).png
  ...
  * mountain_test_1 Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * mountain_test_1 Height Map (SRTM3 v4.1).png
  ...
  * mountain_test_1 Height Map (SRTM30 Plus).png
  ...
  * mountain_test_1 Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1029m (actual) is equal to 40m in
